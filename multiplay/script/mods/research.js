function giveStartingComponents(player)
{
	startingComponents.forEach(c => makeComponentAvailable(c, player));
}

function giveResearch(player)
{
	const timeS = getTotalTimeS();
...
function getStructures(timeS)
{
	...
	const allowedTypes = Object.keys(settings.structPower);
